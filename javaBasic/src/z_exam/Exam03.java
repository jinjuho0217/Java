...
public class Exam03 {
	...
	class Exercise3_1 {
		public static void main(String[] args) {
			...
			System.out.println(1 + x << 33);    = 6(1+x=3 =11 <<하면 110 =6)
		 ...
		 * - int num = 400;
			int c = num/100*100; 
			System.out.println(c); - 나누기를 하면 나머지 값을 버린다.
		 * 
		 * [실행결과] 400
		 * 
		...
		* 		int num = 333; 
		 ...
		 * [3-8] 아래 코드의 문제점을 수정해서 실행결과와 같은 결과를 얻도록 하시오.
			...
			[3-9] 다음은 문자형 변수ch가 영문자 (대문자 또는 소문자)이거나 숫자일 때만 변수 b
			...
			true
		 * 
		 * [3-10] 다음은 대문자를 소문자로 변경하는 코드인데, 문자ch에 저장된 문자가 대문자
			인 경우에만 소문자로 변경한다. 문자코드는 소문자가 대문자보다 32만큼 더 크다 예를
			들어 'A‘의 코드는 65’ 이고 a'의 코드는 97이다. (1)~(2)에 알맞은 코드를 넣으시오.
